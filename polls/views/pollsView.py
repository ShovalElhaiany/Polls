...
"""Class that creates questions"""
# class Q(generic.CreateView):
#     model=Question
#     fields= ['question_text', 'pub_date']
"""Another way to Index View"""
...
class Index(View):
    def get(self, request):
        ...
        """A loop that creates a list of questions"""
...
class NewQuestion(View):
    def post(self, request):
        ...
        if form.is_valid():
            ...
            """If I want to use the object I will do like this"""
